    ...
    export default {
            ...
            return {
                ...
                addData: [
                    ...
                    },
                    {
                        ...
                        prop: "seasons",
                        placeholder: "请输入时令",
                        options: [{value: 1, label:"春季"},{value: 2, label:"夏季"},{value: 3, label:"秋季"},{value: 4, label:"冬季"}]
                    },
                    {
                        label: "价格",
                        type: "inputNumber",
        ...
        methods: {
            ...
            handleAddModalData(fields) {
                ...
                fields.forEach(item => {
                    console.log(333,addModalData[item.label]);
                    if (!addModalData[item.label]){
                        this.$message(`请输入${item.name}`);
                        return
                    }
                });
                console.log(111,addModalData)
            },
            ...
            getList() {
                this.modelSearch["materialIds"] = this.modelSearch["materialIds"].length ? this.modelSearch["materialIds"].join(",") : "";
                let params = {
                    page: 1,
                    rows: 5,
                    ...this.modelSearch
