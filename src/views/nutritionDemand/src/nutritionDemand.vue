  ...
  export default {
    ...
    data() {
      return {
        ...
        addModalData: {},//表单数据
        isCustomAdd: true,
        addCustomData: [],//保存营养及含量对象
        materialNameList: [],// 营养下拉框
        currentPage: 1,
        pageSize: 10,
        ...
        isShowDetail: false,//符合菜品表单是否直接弹出
        detailTitle: "符合的菜品",
        detailHeaders: [//寻找菜品表头
          {
            label: "菜品名称",
            prop: "foodName",
            align: "center"
